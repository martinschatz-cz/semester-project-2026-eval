...
### Manual Count
![Manual count distribution](../images/counts/manual_count_boxplot.png){width=100%}
![Manual count evaluation](../images/counts/cv_manual_count.png){width=100%}
...
![Custom-tuned Fiji macro distribution](../images/counts/script_own_boxplot.png){width=100%}
![Custom-tuned Fiji macro evaluation](../images/counts/cv_script_own.png){width=100%}
...
![Basic thresholding distribution](../images/counts/script_simple_boxplot.png){width=100%}
![Basic global thresholding evaluation](../images/counts/cv_script_simple.png){width=100%}
...
![Watershed distribution](../images/counts/script_watershed_boxplot.png){width=100%}
![Watershed segmentation evaluation](../images/counts/cv_script_watershed.png){width=100%}
...
![Sparse WEKA segmentation distribution](../images/counts/script_own_sparse_boxplot.png){width=100%}
![Sparse WEKA segmentation evaluation](../images/counts/cv_script_own_sparse.png){width=100%}
...
![StarDist distribution](../images/counts/script_SarDist_boxplot.png){width=100%}
![StarDist model evaluation](../images/counts/cv_script_SarDist.png){width=100%}
